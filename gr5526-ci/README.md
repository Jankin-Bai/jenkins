...
| 阶段 | 子阶段 | 说明 |
|---|---|---|
| **1. Prepare Environment** | 1.1 Environment Check | J-Link 自动检测、工具链检查、项目/SDK/CI 工具存在性检查、Python 语法检查 |
| | 1.2 Python Venv Setup | 创建/复用虚拟环境，安装 requirements.txt |
...
- SCM → Git，填入仓库 URL
- Script Path → `gr5526-ci/Jenkinsfile`
- 限制项目运行节点 → `gr5526-hw`
